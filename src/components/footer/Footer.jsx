    ...
    <div className="w-full bottom-0 left-0 max-h-[95vh] md:h-[50vh] text-sm bg-primary text-white flex flex-col ">
      <div className="block md:flex md:max-w-7xl w-full mmax-h-[85%] md:h-[75%] m-auto  p-2 border-b-2 border-white">
        <div className="flex flex-col w-full mx-1 ">
          <div className="flex flex-col max-h-[30%]">
            ...
            <p className="mt-2">
              Let us guide you every step of the way in making your dream home a
              reality.
            </p>
          </div>
          <div className="flex flex-col max-h-[50%] justify-center">
            <span className="flex my-2">
              <CiLocationOn className="me-1" size={20} /> East Wing Court,
              Kenyatta Road, Kenya.
            </span>
            <span className="flex my-2">
              <BsTelephone className="me-1" size={20} />
              +254-7-46-895-735
            </span>
            <span className="flex my-2">
              <PiEnvelopeSimpleThin className="me-1" size={20} />
              info@kulproperties.com
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col mt-3 md:mt-0 mx-1  w-full">
          ...
          <div className="flex  w-full ">
            <div className="flex flex-col w-full mx-2">
              <span className="py-2  hover:font-semibold hover:cursor-pointer">
                About
              </span>
              <span className="py-2  hover:font-semibold hover:cursor-pointer">
                Blog
              ...
              <span className="py-2 hover:font-semibold cursor-pointer">
                Locations
              </span>
            </div>
      ...
      <div className="flex flex-col my-1 md:my-6 mx-auto">
        ...
        <span className=" mx-auto text-sm flex">
          <AiOutlineCopyrightCircle size={20} /> 2023 markmuga. All Rights
          Reserved
        </span>
      </div>
    </div>
