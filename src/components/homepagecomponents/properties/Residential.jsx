    ...
    <Link
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${import.meta.env.BASE_URL}${details.cover_image})`,
                }}
              >
                <div
              ...
              <div className='flex flex-col bg-white w-full rounded-b-md h-[40%] p-2 md:p-4'>
                <span className='items-center  flex justify-between text-base text-red-500'>{details.property_type}<span className='text-sm'>{liked[details.id] ? details.likes + 1: details.likes} {details.likes == 1 ? <span>like</span> : <span>likes</span>}</span></span>
