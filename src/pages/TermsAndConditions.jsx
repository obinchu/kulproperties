    ...
    <div className="flex flex-col">
      ...
      <div className="flex flex-col md:mx-auto md:max-w-6xl w-full h-[35%] md:h-[60vh] md:my-auto md:rounded p-2 ">
        <div className="flex flex-col h-full w-full">
          <span className="w-full h-[10%] text-2xl p-2 text-center font-medium mx-auto">
            We Exist To suite your Needs
          </span>
          <div className="flex h-[90%] w-full">
            <div className="flex flex-col  h-full p-1 w-full m-auto md:max-w-3xl">
              <p className="md:m-2 p-2 text-sm w-full md:text-center">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Odit
                ullam, provident eveniet rem nam tempore nemo doloribus at,
                voluptates, quibusdam doloremque totam vel libero dolores.
                Molestias, nam nulla! Voluptas, provident! Minima corrupti
                tempore quas, molestias, modi dolorem qui magnam a facilis,
                velit accusantium architecto culpa! Excepturi eligendi dolore ad
                blanditiis.
              </p>
              <p className="md:m-2 p-2 text-sm w-full md:text-center">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Odit
